                                    ...
                                    <table id="sample-table-1" class="table table-striped table-bordered table-hover">
                                        ...
                                        <c:forEach var="item" items="${list}">
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="<%=request.getContextPath()%>/article/articleDetails?id=${item.id}"
                                                       target="_blank">${item.title}</a>
                                                </td>
                                                <td>${item.article_type}</td>
                                                <td class="hidden-480">${item.author}</td>
                                                <td><fmt:formatDate value="${item.upload_time}"
    ...
    ;(function ($) {
        ...
        index_function.prototype = {
            ...
            delete: function (obj) {
                ...
                $.ajax({
                    url: "<%=request.getContextPath()%>/articleManager/delete",
                    type: "POST",
                    dataType: "json",
                    data: {"id": id},
