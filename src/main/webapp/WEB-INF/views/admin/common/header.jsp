...
<!-- <link rel="stylesheet" href="<%=request.getContextPath()%>/assets/css/jquery-ui-1.10.3.custom.min.css" />
...
<link rel="stylesheet" type="text/css" href="<%=request.getContextPath()%>/css/yy.css">
