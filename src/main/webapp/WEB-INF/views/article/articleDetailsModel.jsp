    ...
    <div class="am-u-md-8 am-u-sm-12">
        <article class="am-article blog-article-p">
            ...
            <div class="am-article-bd">
                <img src="<%=request.getContextPath()%>/assets/i/f10.jpg" alt=""
                ...
                <h1>一大段文字：</h1>
                <p>
                    我遇见了你，你一直觉得自己不够美好，充满惊慌与卑微，但是，你即使那样害怕，却守在我的身后，不曾后退。人们总是崇拜英雄，惊喜与他们随时随地的光芒，但是最真实的事情永远是我们都会恐惧都会失败，有时受尽打击，又是无能为力。你说我是英雄，其实我不敢告诉你，如果不是你，你傻傻地倔强地站在那里，我一回头就能看见你，那么，或许，我早就做了命运的逃兵。<br><br>
        ...
        <div class="am-g blog-author blog-article-margin">
            ...
            <div class="am-u-sm-9 am-u-md-9 am-u-lg-10">
                <h3><span>作者 &nbsp;: &nbsp;</span><span class="blog-color">奕弈</span></h3>
